...
from ..controllers.state_machine_force_closure import ControlStateMachine
import numpy as np
import os
...
if __name__ == "__main__":
    # car1_hist, car2_hist, block_hist, orig_path, exec_time, goal = run_carpool_simulation(test_case=8, r1=0.95, r2=0.2, at_pushing_pose=True)
    test_cases = [8]
    num_runs = 25

    # Create directory for results
    for test_case in test_cases:
        results_dir = f'force_closure_test{test_case}'
        ...
        for i in tqdm(range(num_runs)):
            ...
            car1_hist, car2_hist, block_hist, orig_path, exec_time, goal = run_carpool_simulation(
                test_case=test_case, r1=0.95, r2=0.2, at_pushing_pose=True
            )
